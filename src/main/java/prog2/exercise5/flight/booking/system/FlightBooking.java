...
public FlightBooking(int a) {
    passengerFullName = new String[a];
    passengerGender = new String[a];
    passengerAge = new int[a];
    ticketNumber = new String[a];
}
...
public void setTripType(String tripTypeNumber){
...
public void setTripSource(String tripSourceNumber){
    switch(tripSourceNumber)
    {
...
public void setSourceAirport(String tripSourceNumber){
    switch(tripSourceNumber)
    {
        case "1" :tripSource = TripSource.NANJING;
                  sourceAirport = SourceAirport.NANJING_LUKOU_INTERNATIONAL_AIRPORT;
